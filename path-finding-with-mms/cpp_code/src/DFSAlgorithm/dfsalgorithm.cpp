...
fp::DFSAlgorithm::DFSAlgorithm(fp::Maze* maze_ptr) : fp::Algorithm::Algorithm(maze_ptr) {}

void fp::DFSAlgorithm::solve(fp::Maze* maze_ptr, fp::LandBasedRobot* wheel_robot)
{
...
bool fp::DFSAlgorithm::generatePath(fp::Maze* maze_ptr, fp::LandBasedRobot* wheel_robot){
